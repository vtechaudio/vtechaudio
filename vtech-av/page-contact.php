	...
	<div class="container quote-grid">
		...
		<aside class="quote-info">
			...
			<ul>
				...
				<li><a href="tel:<?php echo esc_attr( str_replace( ' ', '', vtech_opt( 'vtech_phone', '+254 728135246' ) ) ); ?>"><?php echo esc_html( vtech_opt( 'vtech_phone', '+254 728135246' ) ); ?></a></li>
			...
			<a class="btn btn--accent btn--block" style="margin-top:1.5rem" href="https://wa.me/<?php echo esc_attr( str_replace( ' ', '', vtech_opt( 'vtech_whatsapp', '254703201241' ) ) ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'Chat on WhatsApp', 'vtech-av' ); ?></a>
