...
function vtech_stream_pdf( $id, $download = true ) {
	...
	$pdf->text( get_theme_mod( 'vtech_address', 'Mpaka Plaza, Mpaka Road, Nairobi' ) . '  |  ' . get_theme_mod( 'vtech_phone', '+254 728135246' ) . '  |  ' . get_theme_mod( 'vtech_email', 'info@vtechaudio.co.ke' ), 9 );
	$pdf->rule();
